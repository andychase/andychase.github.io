...
[[Facebook]](http://facebook.com/asper)  <br />
...
<br />
{json var="feed" url={"http://api.twitter.com/1/statuses/user_timeline.json"+
            "?exclude_replies=true"+
            "&oauth_token=14402880-qIo9493d6OKOwHFyeJ8r5OkbD8TGk9qMsrw1aUUhs"+
            "&screen_name=asperous"|strip:''}}
{if {$feed[0].text|strip}!=""}
*{$feed[0].text|linkify} on {$feed[0].created_at|truncate:12:""}*
{/if}
[[Twitter]](http://twitter.com/asperous) <br />


{scrapeweb url="http://www.reddit.com/user/asperous/" find=".karma" var="karma"}
{scrapeweb url="http://steamcommunity.com/id/asperous/games" find="script" var="steam"}
{assign var="steam" value={$steam.5->innertext|substr:15}}
{jsondata var="steam" data=$steam tag="hours_forever"}
<br />
[[Hypem] fav. music](http://hypem.com/asperous)
<br /><br />
[[Steam]
    {$steam} <br /> Dota2 Hrs.](http://steamcommunity.com/id/asperous)

[[Reddit]
    {$karma.0->innertext}|{$karma.1->innertext}  Karma](http://www.reddit.com/user/asperous/)
<br /><br />
{/markdown}
...
[[Github] Code](https://github.com/asperous)
[[Picasa] Pics](https://picasaweb.google.com/116933133784637904048)
<br /><br />
...
{featuredfiles dir="./featured" var="files"}
