<?php /* Smarty version Smarty-3.1.13, created on 2013-03-02 00:36:13
...
</div><h2 id="latest">Latest</h2><?php  $_smarty_tpl->tpl_vars['data'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['data']->_loop = false;
...
?><div class="box"><a href="http://<?php echo $_smarty_tpl->tpl_vars['data']->value[0];?>
"><img src="./featured/<?php echo $_smarty_tpl->tpl_vars['file']->value;?>
" alt="<?php echo $_smarty_tpl->tpl_vars['file']->value;?>
"/></a><?php if ($_smarty_tpl->tpl_vars['data']->value[1]!=''){?><h3><?php echo $_smarty_tpl->tpl_vars['data']->value[1];?>
</h3><?php }?></div><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['boxes']['total']>3&&$_smarty_tpl->getVariable('smarty')->value['foreach']['boxes']['iteration']==3){?><div id="more"><h2>(more)</h2><div id="showonmouseover"><?php }?><?php } ?><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['boxes']['total']>3){?></div></div><?php }?></div></body></html><?php }} ?>